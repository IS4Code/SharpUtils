...
{
	/// <summary>
	/// Exposes a reference to an immutable list as a mutable one.
	/// </summary>
	public class MutableList<T> : MutableCollection<T, ImmutableList<T>>
	{
		public MutableList() : base(ImmutableList.Create<T>())
		{
